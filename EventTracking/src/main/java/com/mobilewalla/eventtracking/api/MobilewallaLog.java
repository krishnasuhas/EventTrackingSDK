...
public class MobilewallaLog {
    private volatile boolean enableLogging = true;
    private volatile int logLevel = Log.INFO;

    protected static MobilewallaLog instance = new MobilewallaLog();

    public static MobilewallaLog getLogger() {
        return instance;
    }

    private MobilewallaLog() {} // prevent instantiation

    MobilewallaLog setEnableLogging(boolean enableLogging) {
        this.enableLogging = enableLogging;
        return instance;
    }

    MobilewallaLog setLogLevel(int logLevel) {
